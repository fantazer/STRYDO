...
$(document).ready(function(){
	$('.portfolio-head-toggle-el').click(function(){
		$('.portfolio-head-toggle-el').removeClass('portfolio-active');
		$(this).addClass('portfolio-active');
		var dataBut = $(this).data('el');
		$('.portfolio-slider').each(function(){
			if ($(this).data('type')===dataBut) {
